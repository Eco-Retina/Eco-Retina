...
This github aims to give access to the latest version of **Eco Retina**, a green interpretable out-of-sample forecasting algorithms.
...
The Eco-Retina code has also been modified. The structure has been simplified and the management of 0 values when continuous substantially improved which led to better performances (**~3% R²**).
